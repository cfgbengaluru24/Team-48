...
const attendanceRoutes = require('./attendanceRoutes.js')const adminRoutes = require('./adminRoutes.js');
...
router.use('/attendance',attendanceRoutes)router.use('/admin',adminRoutes);
